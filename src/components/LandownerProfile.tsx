                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between -mt-16 mb-6">
                        <div className="flex items-end space-x-5">
                            <div className="relative">
                                <div className="w-32 h-32 rounded-full border-4 border-white shadow-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center overflow-hidden">
                                ...
                                {isEditing && (
                                    <label
                                        ...
                                        className="absolute bottom-0 right-0 w-10 h-10 bg-amber-600 hover:bg-amber-700 rounded-full flex items-center justify-center cursor-pointer shadow-lg transition-colors border-2 border-white"
                                    >
                            ...
                            <div className="pb-2">
                                ...
                                <p className="text-gray-500">Landowner</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 md:mt-0 md:pb-2">
                            {!isEditing ? (
                                <button
                                    onClick={handleEdit}
                                    className="flex items-center space-x-2 px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition-colors font-medium shadow-md"
                                >
                                ...
                                <div className="flex space-x-3">
                                    ...
                                    <button
                                        onClick={handleSave}
                                        disabled={saving}
                                        className="flex items-center space-x-2 px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition-colors font-medium shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {saving ? (
                                            <>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="px-4 py-3 bg-amber-50 rounded-lg border border-amber-100">
                                ...
                                <p className="text-sm font-semibold text-amber-700">Landowner</p>
                            </div>
                            <div className="px-4 py-3 bg-amber-50 rounded-lg border border-amber-100">
                                <p className="text-xs text-gray-600 mb-1">Member Since</p>
                                <p className="text-sm font-semibold text-amber-700">{formatMemberSince(createdAt)}</p>
                            </div>
                        </div>
                    </div>
                </div>
